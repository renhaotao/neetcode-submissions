class Solution:
    def isValid(self, s: str) -> bool:
        ...
        if s_length % 2 == 1:
            ...
            while s_substring_length != 0 and N_iteration < 100:
                N_iteration += 1 
            ...
            # while i < s_length:
            #     print("i:", i, "s[i]:", s[i])
            #     is_si_an_opener = s[i] in opening_bracket
            #     if is_si_an_opener:
            #         has_an_open_bracket = True

            #         index_i = opening_bracket.index(s[i])
            #         print('s[i] is index', index_i)
            #         target_closing_i = closing_bracket[index_i]

            #         if s[i+1] == target_closing_i:
            #             print('case 1')
            #             i = i + 2 
            #             has_an_open_bracket = False
            #         elif s[s_length - i - 1] == target_closing_i:
            #             print('case 2')
            #             i = i + 1 
            #             has_an_open_bracket = False
            #         else:
